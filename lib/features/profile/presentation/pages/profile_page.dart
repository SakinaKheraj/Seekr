...
import 'package:seekr/features/profile/presentation/cubit/profile_cubit.dart';
import 'package:seekr/features/profile/presentation/cubit/profile_state.dart';
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) =>
          ProfileCubit(profileService: ProfileService(authRepo: authRepo))
            ..loadProfile(),
